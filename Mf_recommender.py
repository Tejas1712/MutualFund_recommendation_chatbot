...
def chatbot_interaction():
    ...
    file_path = 'C:/Users/Tejas Susladkar/OneDrive/Desktop/Tejas/Python/MF PROJECT/comprehensive_mutual_funds_data.csv'
    ...
    while True:
        ...
        if user_input == 'exit':
            ...
            try:
                ...
                risk_tolerance = int(input("On a scale from 1 (low) to 5 (high), what's your risk tolerance /  ? "))
